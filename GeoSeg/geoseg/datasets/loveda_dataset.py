...
class LoveDATrainDataset(Dataset):
    def __init__(self, data_root='/root/shared-nvme/FSDENet/data/loveDA/Train', img_dir='images_png', mosaic_ratio=0.25,
...
loveda_val_dataset = LoveDATrainDataset(data_root='/root/shared-nvme/FSDENet/data/loveDA/Val', mosaic_ratio=0.0,
                                        transform=val_aug)


class LoveDATestDataset(Dataset):
    def __init__(self, data_root='/root/shared-nvme/FSDENet/data/loveDA/Test', img_dir='images_png',
